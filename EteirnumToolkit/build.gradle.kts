...
tasks {
    shadowJar {
        relocate("dev.jorel.commandapi", "com.eteirnum.shaded.commandapi")
        relocate("com.jeff-media.MorePersistentDataTypes", "com.eteirnum.shaded.more_persistent_data_types")
        relocate("com.github.stefvanschie.inventoryframework", "com.eteirnum.shaded.inventoryframework")
        relocate("com.github.unldenis.holoeasy", "com.eteirnum.shaded.holoeasy")
        relocate("com.github.fierioziy.particlenativeapi", "com.eteirnum.shaded.particlenativeapi")
    }
    assemble {
        dependsOn(reobfJar)
    }
