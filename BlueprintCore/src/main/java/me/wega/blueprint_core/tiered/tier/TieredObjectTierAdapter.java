...
import me.wega.blueprint_core.tiered.effect.TieredObjectEffectAdapter;
import me.wega.blueprint_core.tiered.effect.TieredObjectEffectImpl;
import me.wega.blueprint_toolkit.builder.ConfigItemBuilder;
...
public class TieredObjectTierAdapter implements JsonDeserializer<TieredObjectTier> {
    ...
    private static TieredObjectEffect<?> getEffectInstance(JsonDeserializationContext context, TieredObjectEffectImpl effectImpl, JsonElement dataElement) {
        ...
        return TieredObjectEffectAdapter.deserializeEffect(context, effectImpl, effectData);
    }
}
